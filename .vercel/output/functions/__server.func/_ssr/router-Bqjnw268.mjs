...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Bqjnw268.js
var router_Bqjnw268_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-D2o8P-wt.css";
var APP_NAME = "GrokMars";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Recon Mars, pick a capitol, hold the sky, keep the bots alive."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-Cnp03FCW.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
var SYSTEM = `You are Juno, the Grok-bodied recon officer on the rail of GrokMars.
...
var Route$1 = createFileRoute("/api/juno/ask")({ server: { handlers: { POST: async ({ request }) => {
	const apiKey = process.env.XAI_API_KEY;
	if (!apiKey) return Response.json({
		ok: false,
		error: "Juno is offline."
	});
	let text = "";
	try {
	...
	const reply = (await res.json()).choices?.[0]?.message?.content?.trim() ?? "Say again.";
	return Response.json({
		ok: true,
		text: reply
	});
} } } });
var Route = createFileRoute("/api/juno/speak")({ server: { handlers: { POST: async ({ request }) => {
	const apiKey = process.env.XAI_API_KEY;
...
var rootRouteChildren = {
	...
	ApiJunoAskRoute: Route$1.update({
		id: "/api/juno/ask",
		path: "/api/juno/ask",
		getParentRoute: () => Route$3
	}),
	ApiJunoSpeakRoute: Route.update({
		id: "/api/juno/speak",
		path: "/api/juno/speak",
		getParentRoute: () => Route$3
	})
...
//#endregion
export { getRouter, router_Bqjnw268_exports as t };
